...
export const posts: Post[] = [
  {
    ...
    content: [
      ...
      "",
      "### Step 3: Use the AX Connector in ChatGPT",
      ...
      "- **Pro tip:** Be explicit. For example: 'Use AX.get_agent_status to check agent A, then AX.assign_task to send a job to agent B.'",
      "**Example Prompt:**",
