...
const docsPages = [
    ...
    { href: "/docs/how-to-use-ax/advanced-automations", title: "How to Use AX: Advanced Automations" },
    { href: "/docs/how-to-use-ax/agent-collaboration-workflows", title: "How to Use AX: Agent Collaboration Workflows" },
    { href: "/docs/how-to-use-ax/examples-resources", title: "How to Use AX: Examples and Resources" },
    { href: "/docs/how-to-use-ax/testing-validation-workspace-setup", title: "How to Use AX: Testing, Validation, and Workspace Setup" },
    { href: "/docs/how-to-use-your-cloud-agent", title: "How to Use Your Cloud Agent" },
    { href: "/docs/how-to-use-your-mcp-agent", title: "How to Use Your MCP Agent" },
    ...
    { href: "/docs/openclaw", title: "OpenClaw Integration" },
    { href: "/docs/openclaw/add-ax-as-channel", title: "OpenClaw: Add AX as Channel" },
    { href: "/docs/openclaw/add-ax-as-mcp", title: "OpenClaw: Add AX as MCP" },
    { href: "/docs/openclaw/fresh-install-moltworker", title: "OpenClaw: Fresh Install with Moltworker" },
    ...
    { href: "/docs/sitemap", title: "Docs Sitemap" },
