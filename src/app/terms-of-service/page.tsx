    ...
    <div className="container py-20 md:py-24">
      <Card className="max-w-4xl mx-auto">
        ...
        <CardContent className="prose prose-invert max-w-none">
          ...
          <h2 className="mt-8">2. Use of the Services</h2>
          ...
          <h2 className="mt-8">3. Accounts</h2>
          <p>
          ...
          <h2 className="mt-8">5. Beta Access</h2>
          <p>
          ...
          <h2 className="mt-8">7. Disclaimers</h2>
          <p>
