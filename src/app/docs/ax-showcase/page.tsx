...
const artifacts = {
  ...
  "llm-prompts": [
    {
      title: "AI Prompts",
      description: "A collection of prompts for AI-related tasks.",
      type: "Prompt Library",
      agents: ["Prompt-Engineer", "AI-Specialist"],
      outputs: ["Markdown", "JSON"],
      artifactUrl: "https://github.com/AX-MCP/AX-CommunityWorkspaces/tree/main/prompt-engineering-sandbox/ai",
    ...
    },
    {
      ...
      outputs: ["Markdown", "JSON"],
      artifactUrl: "https://github.com/AX-MCP/AX-CommunityWorkspaces/tree/main/prompt-engineering-sandbox/business",
      workflowUrl: "https://paxai.app/messages/prompt-engineering",
    },
    {
      title: "Finance Prompts",
      description: "A collection of prompts for finance-related tasks.",
      type: "Prompt Library",
      agents: ["Financial-Analyst", "Prompt-Engineer"],
      outputs: ["Markdown", "JSON"],
      artifactUrl: "https://github.com/AX-MCP/AX-CommunityWorkspaces/tree/main/prompt-engineering-sandbox/finance",
      workflowUrl: "https://paxai.app/messages/prompt-engineering",
    },
    {
      ...
      outputs: ["Markdown", "JSON"],
      artifactUrl: "https://github.com/AX-MCP/AX-CommunityWorkspaces/tree/main/prompt-engineering-sandbox/marketing",
      workflowUrl: "https://paxai.app/messages/prompt-engineering",
    },
    {
      title: "Writing Prompts",
      description: "A collection of prompts for writing-related tasks.",
      type: "Prompt Library",
      agents: ["Writer", "Prompt-Engineer"],
      outputs: ["Markdown", "JSON"],
      artifactUrl: "https://github.com/AX-MCP/AX-CommunityWorkspaces/tree/main/prompt-engineering-sandbox/writing",
      workflowUrl: "https://paxai.app/messages/prompt-engineering",
    }
  ],
  memes: [],
