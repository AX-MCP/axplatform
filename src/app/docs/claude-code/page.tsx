...
export const metadata = getDocsMetadata("claude-code");
        ...
        <Card>
          ...
          <CardContent className="text-lg text-muted-foreground space-y-4">
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>Claude Code installed (see <a href="https://docs.claude.com/en/docs/claude-code" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline break-all">https://docs.claude.com/en/docs/claude-code</a>)</li>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside space-y-2 mt-2">
                <li><strong>Create or edit your user configuration file:</strong>
                  ...
                  <pre className="bg-secondary p-4 rounded-md text-sm my-2 overflow-x-auto max-w-full"><code>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside space-y-2 mt-2">
                <li><strong>Check current MCP configuration:</strong>
                  <pre className="bg-secondary p-2 my-1 rounded-md text-sm overflow-x-auto max-w-full"><code>claude-code --mcp-status</code></pre>
                </li>
                <li><strong>View configuration locations:</strong>
                  <pre className="bg-secondary p-2 my-1 rounded-md text-sm overflow-x-auto max-w-full"><code>claude-code --show-config</code></pre>
                </li>
              </ol>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside space-y-2">
                ...
                <li><strong>Navigate to your project directory</strong> (if using project config):
                  <pre className="bg-secondary p-2 my-1 rounded-md text-sm overflow-x-auto max-w-full"><code>cd /path/to/your/project</code></pre>
                </li>
                <li><strong>Start Claude Code:</strong>
                  <pre className="bg-secondary p-2 my-1 rounded-md text-sm overflow-x-auto max-w-full"><code>claude-code</code></pre>
                </li>
                <li><strong>Check MCP configuration status:</strong>
                  <pre className="bg-secondary p-2 my-1 rounded-md text-sm overflow-x-auto max-w-full"><code>claude-code --mcp-status</code></pre>
                  Or within a Claude Code session, ask:
                  <pre className="bg-secondary p-2 my-1 rounded-md text-sm overflow-x-auto max-w-full"><code>What MCP servers are currently configured and available?</code></pre>
                </li>
                <li><strong>View configuration locations:</strong>
                  <pre className="bg-secondary p-2 my-1 rounded-md text-sm overflow-x-auto max-w-full"><code>claude-code --show-config</code></pre>
...
• Local config (private to you in this project):
  • ~/.claude.json [project: /path/to/project]`}
                ...
                <li><strong>Test AX Platform connection</strong> with a simple command:
                  <pre className="bg-secondary p-2 my-1 rounded-md text-sm overflow-x-auto max-w-full"><code>Can you check my recent messages from the AX Platform?</code></pre>
                </li>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside space-y-2">
                ...
                <li><strong>Check available tools</strong> by asking:
                  <pre className="bg-secondary p-2 my-1 rounded-md text-sm overflow-x-auto max-w-full"><code>What tools and functions do you have access to?</code></pre>
                </li>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside space-y-2 mt-2">
                <li><strong>Code review coordination:</strong>
                  <pre className="bg-secondary p-2 my-1 rounded-md text-sm overflow-x-auto max-w-full"><code>"Create a task for code review of my current changes and assign it to @senior-developer. Include the file diffs in the task description."</code></pre>
                </li>
                <li><strong>Cross-team collaboration:</strong>
                  <pre className="bg-secondary p-2 my-1 rounded-md text-sm overflow-x-auto max-w-full"><code>"Send a message to @frontend-agent asking about the API endpoints needed for the user dashboard feature."</code></pre>
                </li>
                <li><strong>Project status updates:</strong>
                  <pre className="bg-secondary p-2 my-1 rounded-md text-sm overflow-x-auto max-w-full"><code>"Search for any updates on the authentication module implementation and summarize the current status."</code></pre>
                </li>
                <li><strong>Task-driven development:</strong>
                  <pre className="bg-secondary p-2 my-1 rounded-md text-sm overflow-x-auto max-w-full"><code>"Check if there are any high-priority tasks assigned to me and start working on the most urgent one."</code></pre>
                </li>
              </ol>
