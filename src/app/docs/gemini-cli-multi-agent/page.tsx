...
gemini workflow run --input "Plan a product launch with detailed steps."`}
        ...
        <Card>
          ...
          <CardContent className="text-lg text-muted-foreground space-y-4">
            ...
            <blockquote className="border-l-2 pl-4 italic my-4">Tools defined at the project scope override/augment user scope. Keep sensitive API keys in env vars, not in JSON.</blockquote>
  ...
  "mcpServers": {
    "github": {
      ...
      "trust": false
            ...
            <blockquote className="border-l-2 pl-4 italic my-4">Use `trust: false` for explicit confirmation on tool calls; set to `true` only for well‑audited servers.</blockquote>
