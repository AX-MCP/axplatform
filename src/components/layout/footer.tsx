      ...
      <div className="container py-12">
        <div className="flex flex-col md:flex-row justify-between items-start gap-10">
          ...
          <div className="flex gap-12">
            <div className="flex flex-col gap-2.5 text-sm text-center md:text-left">
              ...
              <Link href="https://discord.gg/GjGPFQd8yn" className="text-muted-foreground hover:text-primary transition-colors" target="_blank" rel="noopener noreferrer">Discord</Link>
            </div>
            <div className="flex flex-col gap-2.5 text-sm text-center md:text-left">
        ...
        <div className="mt-10 pt-8 border-t border-border/20 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-3 items-center">
            ...
            <Link href="https://discord.gg/GjGPFQd8yn" className="text-muted-foreground hover:text-primary transition-colors" target="_blank" rel="noopener noreferrer">
              <svg className="h-[18px] w-[18px]" fill="currentColor" viewBox="0 0 24 24">
